...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE customer set  c_name='" . $_POST['c_name'] . "', c_email_id='" . $_POST['c_email_id'] . "', c_gender='" . $_POST['c_gender'] . "', c_age='" . $_POST['c_age'] . "', c_pno='" . $_POST['c_pno'] . "', c_address='" . $_POST['c_address'] . "' WHERE c_id='" . $_GET['c_id'] . "' ");
...
<td colspan="2">Edit Customer of ID :<?php echo $row['c_id']; ?></td>
 ...
 <td> <input type="text" id="c_email_id" name="c_email_id" value="<?php echo $row['c_email_id']; ?>"></td>
</tr>
...
<td> <label for="address">Address</label></td>
    ...
    <br>
<td> <textarea id="c_address" name="c_address" style="height:50px; width:500px" value="<?php echo $row['c_address']; ?>"></textarea> </td>
</tr>
